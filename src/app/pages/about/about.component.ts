...
@Component({
  selector: 'app-about',
  imports: [DropAreaComponent, CardCarouselComponent, TranslateModule, RevealDirective],
...
export class AboutComponent {
  ...
  cards: CardItem[] = [
    { title: 'Eu mesmo!', subtitle: 'Henrique', image: 'Henrique-2.webp' },
    { title: 'Zaira', subtitle: 'Zaira', image: 'zaira.webp' },
    { title: 'Setup', subtitle: 'Setup', image: 'image.webp' },
    { title: 'voando', subtitle: 'voando', image: 'voando.webp' },
    { title: 'Eu mesmoo!', subtitle: 'Henrique', image: 'hns1.webp' },
    { title: 'Eu mesmoo!', subtitle: 'Henrique', image: 'Praia.webp' },
    { title: 'Setup-2', subtitle: 'MG_5824', image: 'IMG_5824.webp' },
    // { title: 'Setup-2', subtitle: '6AF19D3-', image: 'Henrique-4.webp' },
    { title: 'Setup-2', subtitle: 'Setup-2', image: 'Setup-2.webp' },
  ];
